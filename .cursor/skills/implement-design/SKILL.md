...
description: Translates Figma designs into production-ready code with pixel-perfect accuracy using the Figma MCP server. Use when implementing a Figma frame, screen, or component from a Figma URL.
---
