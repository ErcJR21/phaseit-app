...
description: Connects Figma design components to code implementations using Code Connect. Use when mapping Figma components to codebase components or setting up Code Connect mappings.
---
