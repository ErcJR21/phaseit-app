...
description: Generates custom design system rules for Figma-to-code workflows in the current project. Use when the user asks to create design system rules, generate rules for the project, or set up design conventions.
---
